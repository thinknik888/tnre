...
(function() {
  ...
  function createPanel() {
    ...
    // Greeting
    addMessage('assistant', "Hi, I\u2019m Sofia. I can help you explore floor plans, pricing, and book a private showing with Nikhil. What are you looking for today?");
  ...
  function sendMessage() {
    ...
    // API call
    if (!SOFIA_API_KEY) {
      typing.textContent = "I\u2019m not fully connected yet \u2014 but you can reach Nikhil directly at 647-924-0848 or text him to book a showing. He\u2019ll be happy to help!";
    ...
    .then(function(data) {
      var reply = data.content && data.content[0] ? data.content[0].text : "I\u2019m having trouble connecting. Please reach Nikhil directly at 647-924-0848.";
      typing.textContent = reply;
      typing.className = 'sofia-msg assistant';
      conversationHistory.push({ role: 'assistant', content: reply });
    })
    .catch(function() {
      typing.textContent = "I\u2019m having trouble connecting. You can reach Nikhil directly at 647-924-0848.";
      typing.className = 'sofia-msg assistant';
      conversationHistory.push({ role: 'assistant', content: typing.textContent });
    });
  }
