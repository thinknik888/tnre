...
exports.handler = async function(event) {
  ...
  try {
    ...
    var client = {
      ...
      selling_address: String(body.selling_address || '').trim(),
      listing_price: num(body.listing_price),
      sale_price: num(body.sale_price),
      selling_commission_percent: num(body.selling_commission_percent),
      selling_brokerage_split_percent: num(body.selling_brokerage_split_percent),
