...
exports.handler = async function(event) {
  ...
  try {
    ...
    console.error('delete-client error:', err.name, err.message, err.stack);
    return { statusCode: 500, headers: corsHeaders, body: JSON.stringify({ error: 'Failed to delete client', message: err.message, type: err.name }) };
  }
};
